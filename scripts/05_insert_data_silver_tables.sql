...
BEGIN
    ...
    BEGIN TRY
        ...
        INSERT INTO silver.crm_users (
            ...
            country, device_type, acquisition_channel, dwh_create_time
        )
        SELECT
            user_id,
            TRIM(name),
        ...
        INSERT INTO silver.crm_user_activity (
            ...
            event_time, device, dwh_create_time
        )
        SELECT
            event_id,
            user_id,
        ...
        INSERT INTO silver.erp_merchants (
            ...
            country, onboard_date, risk_score, dwh_create_time
        )
        SELECT
            merchant_id,
            merchant_name,
        ...
        INSERT INTO silver.erp_transactions (
            ...
            currency, payment_method, merchant_id,
            status, fraud_flag, dwh_create_time
        )
        SELECT
            txn_id,
            user_id,
        ...
        INSERT INTO silver.erp_fees (
            txn_id, processing_fee, service_fee,
            fx_fee, total_fee, dwh_create_time
        )
        SELECT
            txn_id,
            processing_fee,
            service_fee,
            fx_fee,
            processing_fee + service_fee + fx_fee,
            GETDATE()
        FROM (
            SELECT
                f.txn_id,
        ...
        INSERT INTO silver.erp_fraud_signals (
            txn_id, ip_address, location,
            device_id, risk_score, dwh_create_time
        )
        SELECT
            txn_id,
            ip_address,
        ...
        INSERT INTO silver.erp_refunds (
            refund_id, txn_id, refund_amount,
            refund_date, reason, dwh_create_time
        )
        SELECT
            refund_id,
            txn_id,
